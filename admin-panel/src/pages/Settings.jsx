            ...
            <div className="bg-white/40 backdrop-blur-md p-8 rounded-[2.5rem] shadow-sm border border-brand-pink/10 space-y-6">
                ...
                <form onSubmit={handlePasswordSubmit} className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full bg-brand-blue-dark text-white rounded-2xl py-4 hover:bg-brand-blue-dark/90 transition-all duration-300 flex items-center justify-center space-x-2 text-sm shadow-brand-blue/20 disabled:opacity-50 mt-4 shadow-lg shadow-brand-blue-dark/20 font-bold"
                    >
